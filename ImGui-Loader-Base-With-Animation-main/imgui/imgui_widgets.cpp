...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    window->DrawList->AddRectFilled(rect.Min, rect.Max, ImColor(211, 172, 129, 255), 3.f);

    window->DrawList->AddRectFilled(rect.Min, rect.Max, ImColor(211, 172, 129, it_anim->second.active_rect_alpha), 3.f);

    window->DrawList->AddRect(rect.Min, rect.Max, ImColor(211, 172, 129, (15 + it_anim->second.active_outline_anim)), 3.f);

    PushStyleColor(ImGuiCol_Text, ImVec4(ImColor(43, 22, 8, 255)));
