...
int APIENTRY WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
    ...
    if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
    {
        ...
        style.Colors[ImGuiCol_Text] = ImVec4(211.f, 172.f, 129.f, 255.f);
        style.Colors[ImGuiCol_Button] = ImVec4(211.f, 172.f, 129.f, 255.f);
    }
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        if (Menu::tab == 1)
        {
            Menu::Theme();
            {
                ImGui::Begin("yes bebe alors bien ?", nullptr, ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoResize);
                {
                    ...
                    ImGui::PushStyleColor(ImGuiCol_Text, IM_COL32(255, 255, 255, 1.f));
                    ImGui::PushFont(BigBigGay);
                    ImGui::TextColored(ImColor(200, 200, 200), "EVOL");
                    ImGui::SetCursorPos(ImVec2(285, 30));
                    ImGui::TextColored(ImColor(77, 125, 253), "UTION");
                    ImGui::SetCursorPos(ImVec2(320, 30));
                    //ImGui::TextColored(ImColor(255, 255, 255, 255), ".WIN");
                    ...
                    //ImGui::PushStyleColor(ImGuiCol_Button, IM_COL32(211, 172, 129, 255));
                  
                    if (ImGui::Button("Sign in", ImVec2(350, 42)))
                    {
