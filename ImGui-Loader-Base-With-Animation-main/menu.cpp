...
void Menu::Theme()
{
	...
	Style.WindowMinSize     = ImVec2(850, 550);
	...
	Color[ImGuiCol_FrameBg]		        = ImColor(18, 18, 24, 255);
	Color[ImGuiCol_FrameBgActive]       = ImColor(18, 17, 17, 255);
	Color[ImGuiCol_FrameBgHovered]      = ImColor(18, 17, 17, 255);

	Color[ImGuiCol_Button]	            = ImColor(211, 172, 129, 255);
	Color[ImGuiCol_ButtonActive]        = ImColor(211, 172, 129, 255);
	Color[ImGuiCol_ButtonHovered]       = ImColor(211, 172, 129, 255);
